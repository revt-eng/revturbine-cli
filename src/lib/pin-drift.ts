 ...
 * drift from the committed one). SDK guidance separately checks the latest
 * stable release without prescribing range syntax (plan 254 TASK-12).
 * Pure: takes parsed package.json content; the CLI owns IO.
 */
 ...
 * or when the CLI pin follows the rule.
 */
